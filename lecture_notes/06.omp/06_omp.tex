...
\end{align*}
\item Collect terms and use the results on price dispersion from Lecture 5. (Full details in Gali Appendix 4.A.)
\begin{align*}
...
\item Note that this is due to Calvo.
...
\item Use the first result on the slide
