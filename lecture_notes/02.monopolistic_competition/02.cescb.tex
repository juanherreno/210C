...
\item Studying how firms choose prices in models where no one sets prices is not promising
\end{itemize}
\item Today is a framework lecture
\begin{itemize}
...
\item $C_t$ is often called a Dixit-Stiglitz aggregator. 
